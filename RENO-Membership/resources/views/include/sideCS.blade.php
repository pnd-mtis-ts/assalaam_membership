...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto dark:bg-gray-800" 
        ...
        <ul class="space-y-2 mt-2 font-medium">
            ...
            <li>
                <a href="/adduser"
                    class="flex items-center p-2 rounded-xl transition duration-300 group"
                    :class="isActive('/adduser') ? 'bg-green-500 text-white shadow-md' : 'text-green-500 dark:text-[#F97300] hover:bg-green-600 hover:text-white'">
                    <ion-icon name="layers" class="w-5 h-5 ml-1"></ion-icon>
                    <span class="ms-3">Tambah User</span>
                </a>
            </li>
            <li>
                <a href="/form_ubah_poin"
                    class="flex items-center p-2 rounded-xl transition duration-300  group" :class="isActive('/form_ubah_poin') ? 'bg-green-500 text-white shadow-md' : 'text-green-500 dark:text-[#F97300] hover:bg-green-600 hover:text-white'">
